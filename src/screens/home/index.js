...
class Home extends Component {
  render() {
    return (
        <body className="m-index" data-scrolling-animations="true" data-equal-height=".b-auto__main-item">
                    ...
                    <div className="collapse navbar-collapse navbar-main-slide" id="nav">
                      <ul className="navbar-nav-menu">
                        <li className="dropdown">
                          <Link className="dropdown-toggle" data-toggle='dropdown' to="/">Home <span
                              className="fa fa-caret-down"></span></Link>
                        ...
                        <li className="dropdown">
                          ...
                          <ul className="dropdown-menu h-nav">
                            <li><Link to="/listings">listing 1</Link></li>
                            <li><Link to="/listings">listing 2</Link></li>
                            <li><Link to="/listings">listing 3</Link></li>
                            <li><Link to="/listings">listing 4</Link></li>
                          </ul>
                        </li>
            ...
            <div id="carousel" className="slide carousel carousel-fade">
              <div className="carousel-inner">
                <div className="item active">
                  <img src={require("../../media/main-slider/1.jpg")} alt="sliderImg"/>
                  <div className="container">
                ...
                <div className="item">
                  <img src={require("../../media/main-slider/2.jpg")} alt="sliderImg"/>
                  <div className="container">
                    <div className="carousel-caption b-slider__info">
                      <h3>Find your dream</h3>
                      <h2>Lamborghini Aventador</h2>
                ...
                <div className="item">
                  <img src={require("../../media/main-slider/3.jpg")} alt="sliderImg"/>
                  <div className="container">
                    <div className="carousel-caption b-slider__info">
                      <h3>Find your dream</h3>
                      <h2>Lamborghini Aventador</h2>
          ...
          <section className="b-search">
            <div className="container">
              <form action="listings.html" method="POST" className="b-search__main">
                <div className="b-search__main-title wow zoomInUp" data-wow-delay="0.3s">
                  <h2>UNSURE WHICH VEHICLE YOU ARE LOOKING FOR? FIND IT HERE</h2>
                </div>
                <div className="b-search__main-type wow zoomInUp" data-wow-delay="0.3s">
                  <div className="col-xs-12 col-md-2 s-noLeftPadding">
                  ...
                  <div className="col-xs-12 col-md-10">
                    <div className="row">
                      <div className="col-xs-2">
                        ...
                        <label htmlFor="type1" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type1">Pickup</label></h5>
                      </div>
                      <div className="col-xs-2">
                        <input id="type2" type="radio" name="type"/>
                        <label htmlFor="type2" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type2">Suv</label></h5>
                      </div>
                      <div className="col-xs-2">
                        <input id="type3" type="radio" name="type"/>
                        <label htmlFor="type3" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type3">Coupe</label></h5>
                      </div>
                      <div className="col-xs-2">
                        <input id="type4" type="radio" name="type"/>
                        <label htmlFor="type4" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type4">Convertible</label></h5>
                      </div>
                      <div className="col-xs-2">
                        <input id="type5" type="radio" name="type"/>
                        <label htmlFor="type5" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type5">Sedan</label></h5>
                      </div>
                      <div className="col-xs-2">
                        <input id="type6" type="radio" name="type"/>
                        <label htmlFor="type6" className="b-search__main-type-svg">
                        ...
                        <h5><label htmlFor="type6">Minicar</label></h5>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="b-search__main-form wow zoomInUp" data-wow-delay="0.3s">
                  <div className="row">
                    ...
                    <div className="col-md-4 col-xs-12 text-left s-noPadding">
                      <div className="b-search__main-form-range">
                        ...
                        <input type="hidden" name="min" className="j-min"/>
                        <input type="hidden" name="max" className="j-max"/>
                      </div>
                      <div className="b-search__main-form-submit">
                        <a href="#">Advanced search</a>
                        <Link to='/listings' type="submit" className="btn m-btn">Search the Vehicle<span
                            className="fa fa-angle-right"></span></Link>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section className="b-featured">
            <div className="container">
              ...
              <div id="carousel-small" className="owl-carousel enable-owl-carousel" data-items="4"
                ...
                <div>
                  <div className="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                    <a href="detail.html">
                      <img src={require("../../media/186x113/mers.jpg")} alt="mers"/>
                ...
                <div>
                  <div className="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                    <a href="detail.html">
                      <img src={require("../../media/186x113/audi.jpg")} alt="audi"/>
                    </a>
                    <div className="b-featured__item-price">
                      $95,900
                    </div>
                ...
                <div>
                  <div className="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                    <a href="detail.html">
                      <img src={require("../../media/186x113/aston.jpg")} alt="aston"/>
                ...
                <div>
                  <div className="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                    <a href="detail.html">
                      <img src={require("../../media/186x113/jaguar.jpg")} alt="jaguar"/>
                    </a>
                    <div className="b-featured__item-price">
                      $130,825
                    </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
                  <div className="b-welcome__text wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                ...
                <div className="col-md-5 col-sm-6 col-xs-12">
                  <div className="b-welcome__services wow fadeInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    <div className="row">
                      ...
                      <div className="col-xs-6 m-padding">
                        <div className="b-welcome__services-trade">
                      ...
                      <div className="col-xs-6 m-padding">
                        <div className="b-welcome__services-support">
          ...
          <section className="b-world">
            <div className="container">
              <h6 className="wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">EVERYTHING YOU NEED TO
                KNOW</h6><br/>
              <h2 className="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">THE WORLD OF
                AUTOS</h2>
              <div className="row">
                <div className="col-sm-4 col-xs-12">
                  <div className="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    <img className="img-responsive" src={require("../../media/370x200/wolks.jpg")} alt="wolks"/>
                    <div className="b-world__item-val">
                      <span className="b-world__item-val-title">FIRST DRIVE REVIEW</span>
                    ...
                    <p>Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat. Aenean vitae quam. Vivamus
                      et nunc. Nunc consequ
                      sem velde metus imperdiet lacinia.</p>
                    <a href="article.html" className="btn m-btn">READ MORE<span
                        className="fa fa-angle-right"></span></a>
                  </div>
                </div>
                <div className="col-sm-4 col-xs-12">
                  <div className="b-world__item wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img className="img-responsive" src={require("../../media/370x200/mazda.jpg")} alt="mazda"/>
                    <div className="b-world__item-val">
                      <span className="b-world__item-val-title">INSTRUMENTED TEST</span>
                      <div className="b-world__item-val-circles">
                        <span></span>
                        <span></span>
                        <span></span>
                    ...
                    <a href="article.html" className="btn m-btn m-active">READ MORE<span
                        className="fa fa-angle-right"></span></a>
                  </div>
                </div>
                <div className="col-sm-4 col-xs-12">
                  <div className="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    <img className="img-responsive" src={require("../../media/370x200/chevrolet.jpg")} alt="chevrolet"/>
                    <div className="b-world__item-val">
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                  <div className="b-asks__first wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <div className="b-asks__first-arrow">
                      <a href="listingsTwo.html"><span className="fa fa-angle-right"></span></a>
                    </div>
                  </div>
                </div>
                <div className="col-md-6 col-sm-10 col-sm-offset-1 col-xs-12 col-md-offset-0">
                  <div className="b-asks__first m-second wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    <div className="b-asks__first-circle">
                ...
                <div className="col-xs-12">
                  <p className="b-asks__call wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">QUESTIONS? CALL
                    US : <span>1-800- 624-5462</span></p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="b-auto">
            <div className="container">
              <h5 className="s-titleBg wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">GIVING OUR CUSTOMERS
                BEST DEALS</h5><br/>
              <h2 className="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">BEST OFFERS FROM
                AUTOCLUB</h2>
              <div className="row">
                <div className="col-xs-5 col-sm-4 col-md-3">
                  <aside className="b-auto__main-nav wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    <ul>
                      <li className="active"><a href="#">All Manufacturers</a><span
                ...
                <div className="col-md-9 col-sm-8 col-xs-7">
                  <div className="b-auto__main">
                    <div className="col-md-11 col-md-offset-1 col-xs-12">
                      <a href="#" className="b-auto__main-toggle s-lineDownCenter m-active j-tab wow zoomInLeft"
                         data-wow-delay="0.3s" data-wow-offset="100" data-to="#first">MOST RESEARCHED MANUFACTURERS</a>
                      <a href="#" className="b-auto__main-toggle j-tab wow zoomInRight" data-wow-delay="0.3s"
                         data-wow-offset="100" data-to="#second">LATEST VEHICLES ON SALE</a>
                    </div>
                    <div className="clearfix"></div>
                    <div className="row m-margin" id="first">
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/acura.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                      ...
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/nissan.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                          ...
                          <div className="b-auto__main-item-info">
                            ...
                            <span className="m-number">
												<span className="fa fa-tachometer"></span>12,000 KM
											</span>
                          </div>
                          <div className="b-featured__item-links m-auto">
                            <a href="#">Used</a>
                      ...
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/acura2016.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                          ...
                          <div className="b-auto__main-item-info">
                            ...
                            <span className="m-number">
												<span className="fa fa-tachometer"></span>5,000 KM
											</span>
                          </div>
                          <div className="b-featured__item-links m-auto">
                            <a href="#">Used</a>
                      ...
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/amg.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                      ...
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/brabus.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                      ...
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/range.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                            <span className="b-world__item-val-title">REGISTERED <span>2014</span></span>
                          </div>
                    ...
                    <div className="row m-margin" id="second">
                      <div className="col-md-4 col-sm-6 col-xs-12">
                        <div className="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                          <img className="img-responsive" src={require("../../media/270x150/acura.jpg")} alt="mazda"/>
                          <div className="b-world__item-val">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-3 col-xs-6">
                      <div className="b-count__item j-last">
                        ...
                        <div className="chart" data-percent="547">
          ...
          <section className="b-contact">
            <div className="container">
              <div className="row wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                <div className="col-xs-4">
                ...
                <div className="col-xs-8">
                  <div className="b-contact__form">
                    <p>WE SEND GREAT DEALS AND LATEST AUTO NEWS TO OUR SUBSCRIBED USERS EVERY WEEK. ITS FREE SO
                      SUBSCRIBE TODAY!</p>
                    <form action="/" method="POST">
                      <div><span className="fa fa-user"></span><input type="text" name="user" value=""
                                                                      placeholder="Your Name"/></div>
                      <div><span className="fa fa-envelope"></span><input type="text" name="email" value=""
          ...
          <section className="b-review">
            <div className="container">
              <div className="col-sm-10 col-sm-offset-1 col-xs-12">
                <div id="carousel-small-rev" className="owl-carousel enable-owl-carousel" data-items="1"
                     data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="1"
                     data-items-desktop-small="1" data-items-tablet="1" data-items-tablet-small="1">
                  <div className="b-review__main">
                    <div className="b-review__main-person">
                      <div className="b-review__main-person-inside">
                      </div>
                    </div>
                    <h5><span>DONALD BROOKS</span>, Customer, Ferrari 488 GTB 2 Owner<em>"</em></h5>
                    <p>Donec facilisis velit eust. Phasellus cons quat. Aenean vitae quam. Vivamus et nunc. Nunc
                      consequsem
                      velde metus imperdiet lacinia. Nam rutrum congue diam. Vestibulum acda risus eros auctor egestas.
                      Morbids sem magna, viverra quis sollicitudin quis consectetuer quis nec magna.</p>
                  </div>
                  <div className="b-review__main">
                    <div className="b-review__main-person">
                      <div className="b-review__main-person-inside">
            ...
            <img src={require("../../images/backgrounds/reviews.jpg")} alt="" className="img-responsive center-block"/>
          </section>
          {/*b-review*/}
              ...
              <div className="row">
                <div className="col-md-9 col-md-offset-3 col-xs-6 col-xs-offset-6">
                  <ul className="b-features__items">
                    <li className="wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">Low Prices, No Haggling
                    </li>
                    <li className="wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">Largest Car Dealership</li>
                    <li className="wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">Multipoint Safety Check
                    </li>
                  </ul>
                </div>
              </div>
